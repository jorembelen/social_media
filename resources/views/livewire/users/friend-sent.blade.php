                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="btn-8585 mb-20">
                                    <a href="{{ route('friends.request') }}" class="afltr-btn ">Received</a>
                                    <a href="{{ route('friends.sent') }}" class="afltr-btn afltr-active">Sent</a>
                                </div>
                                        ...
                                        @foreach ($connections as $connection)
                                            <div class="jobs-list">
                                                <div class="media invite125 d-md-flex">
                                                    <div class="job-left">
                                                        <img class="ft-plus-square job-bg-circle bg-cyan me-0" src="/assets/images/left-imgs/img-{{ $connection->user->avatar() }}.jpg" alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <a href="#" class="job-heading pt-0">{{ $connection->user->getFullName() }}</a>
                                                    ...
                                                    <div class="media-btns">
                                                        <button type="button" class="accpt-btn btn-hover accpt-btn-clr wthdrwbtn" wire:click.prevent="remove('{{ $connection->friend->id }}')">Withdraw</button>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
