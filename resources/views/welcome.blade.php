        ...
        <div class="row feed-body">
            <div class="col-xl-8 col-xxl-9 col-lg-8">
                ...
                <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                    ...
                    <div class="card-body d-block p-0">
                        <div class="row ps-2 pe-2">
                            <div class="col-xs-4 col-sm-4 p-1"><a href="/assets/images/t-10.jpg" data-lightbox="roadtrip"><img src="/assets/images/t-10.jpg" class="rounded-3 w-100" alt="image"></a></div>
                            <div class="col-xs-4 col-sm-4 p-1"><a href="/assets/images/t-11.jpg" data-lightbox="roadtrip"><img src="/assets/images/t-11.jpg" class="rounded-3 w-100" alt="image"></a></div>
                            <div class="col-xs-4 col-sm-4 p-1"><a href="/assets/images/t-12.jpg" data-lightbox="roadtrip" class="position-relative d-block"><img src="/assets/images/t-12.jpg" class="rounded-3 w-100" alt="image"><span class="img-count font-sm text-white ls-3 fw-600"><b>+2</b></span></a></div>
                        </div>
                    </div>
                ...
                <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-0">
                    <div class="card-body p-0 d-flex">
                        <figure class="avatar me-3 m-0"><img src="/assets/images/user-8.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                ...
                <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-0">
                    ...
                    <div class="card-body d-block p-0 mb-3">
                        <div class="row ps-2 pe-2">
                            <div class="col-xs-6 col-sm-6 p-1"><a href="/assets/images/t-36.jpg" data-lightbox="roadtri"><img src="/assets/images/t-21.jpg" class="rounded-3 w-100" alt="image"></a></div>
                            <div class="col-xs-6 col-sm-6 p-1"><a href="/assets/images/t-32.jpg" data-lightbox="roadtri"><img src="/assets/images/t-22.jpg" class="rounded-3 w-100" alt="image"></a></div>
                        </div>
                        <div class="row ps-2 pe-2">
                            <div class="col-xs-4 col-sm-4 p-1"><a href="/assets/images/t-33.jpg" data-lightbox="roadtri"><img src="/assets/images/t-23.jpg" class="rounded-3 w-100" alt="image"></a></div>
                            <div class="col-xs-4 col-sm-4 p-1"><a href="/assets/images/t-34.jpg" data-lightbox="roadtri"><img src="/assets/images/t-24.jpg" class="rounded-3 w-100" alt="image"></a></div>
                            <div class="col-xs-4 col-sm-4 p-1"><a href="/assets/images/t-35.jpg" data-lightbox="roadtri" class="position-relative d-block"><img src="/assets/images/t-25.jpg" class="rounded-3 w-100" alt="image"><span class="img-count font-sm text-white ls-3 fw-600"><b>+2</b></span></a></div>
                        </div>
                    </div>
                    <div class="card-body d-flex p-0">
                        <a href="#" class="emoji-bttn d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss me-2"><i class="feather-thumbs-up text-white bg-primary-gradiant me-1 btn-round-xs font-xss"></i> <i class="feather-heart text-white bg-red-gradiant me-2 btn-round-xs font-xss"></i>2.8K Like</a>
                ...
                <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-0">
                    ...
                    <div class="card-body d-block p-0 mb-3">
                        <div class="row ps-2 pe-2">
                            <div class="col-sm-12 p-1"><a href="/assets/images/t-30.jpg" data-lightbox="roadtr"><img src="/assets/images/t-31.jpg" class="rounded-3 w-100" alt="image"></a></div>
                        </div>
                    </div>
                    <div class="card-body d-flex p-0">
                        <a href="#" class="emoji-bttn d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss me-2"><i class="feather-thumbs-up text-white bg-primary-gradiant me-1 btn-round-xs font-xss"></i> <i class="feather-heart text-white bg-red-gradiant me-2 btn-round-xs font-xss"></i>2.8K Like</a>
            ...
            <div class="col-xl-4 col-xxl-3 col-lg-4 ps-lg-0">
                <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                    ...
                    <div class="card-body d-flex pt-0 ps-4 pe-4 pb-0">
                        <figure class="avatar me-3"><img src="/assets/images/user-12.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                        <h4 class="fw-700 text-grey-900 font-xssss mt-1">Mohannad Zitoun <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">12 mutual friends</span></h4>
                    </div>
                    <div class="card-body d-flex align-items-center pt-0 ps-4 pe-4 pb-4">
                        <a href="#" class="p-2 lh-20 w100 bg-primary-gradiant me-2 text-white text-center font-xssss fw-600 ls-1 rounded-xl">Confirm</a>
                ...
                <div class="card w-100 shadow-xss rounded-xxl border-0 p-0 ">
                    ...
                    <div class="card-body bg-transparent-card d-flex p-3 bg-greylight ms-3 me-3 rounded-3">
                        <figure class="avatar me-2 mb-0"><img src="/assets/images/user-7.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                    ...
                    <div class="card-body bg-transparent-card d-flex p-3 bg-greylight m-3 rounded-3" style="margin-bottom: 0 !important;">
                        <figure class="avatar me-2 mb-0"><img src="/assets/images/user-8.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                    ...
                    <div class="card-body bg-transparent-card d-flex p-3 bg-greylight m-3 rounded-3">
                        <figure class="avatar me-2 mb-0"><img src="/assets/images/user-12.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                ...
                <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3 mt-3">
                    ...
                    <div class="card-body d-flex pt-4 ps-4 pe-4 pb-0 overflow-hidden border-top-xs bor-0">
                        <img src="/assets/images/e-2.jpg" alt="img" class="img-fluid rounded-xxl mb-2">
                    </div>
                    <div class="card-body dd-block pt-0 ps-4 pe-4 pb-4">
                        <ul class="memberlist mt-1 mb-2 ms-0 d-block">
                            <li class="w20"><a href="#"><img src="/assets/images/user-6.png" alt="user" class="w35 d-inline-block" style="opacity: 1;"></a></li>
                            <li class="w20"><a href="#"><img src="/assets/images/user-7.png" alt="user" class="w35 d-inline-block" style="opacity: 1;"></a></li>
                            <li class="w20"><a href="#"><img src="/assets/images/user-8.png" alt="user" class="w35 d-inline-block" style="opacity: 1;"></a></li>
                            <li class="w20"><a href="#"><img src="/assets/images/user-3.png" alt="user" class="w35 d-inline-block" style="opacity: 1;"></a></li>
                ...
                <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                    ...
                    <div class="card-body d-flex pt-4 ps-4 pe-4 pb-0 overflow-hidden border-top-xs bor-0">
                        <img src="/assets/images/g-2.jpg" alt="img" class="img-fluid rounded-xxl mb-2">
                    </div>
                    <div class="card-body d-flex align-items-center pt-0 ps-4 pe-4 pb-4">
                    ...
                    <div class="card-body d-flex pt-0 ps-4 pe-4 pb-0 overflow-hidden">
                        <img src="/assets/images/g-3.jpg" alt="img" class="img-fluid rounded-xxl mb-2 bg-lightblue">
                    </div>
                    <div class="card-body d-flex align-items-center pt-0 ps-4 pe-4 pb-4">
                        <a href="#" class="p-2 lh-28 w-100 bg-grey text-grey-800 text-center font-xssss fw-700 rounded-xl"><i class="feather-external-link font-xss me-2"></i> Like Page</a>
                    </div>
